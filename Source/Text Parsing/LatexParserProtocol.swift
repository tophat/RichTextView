...
@objc public protocol LatexParserProtocol: AnyObject {
    @objc func extractLatex(from input: String, textColor: UIColor, baselineOffset: CGFloat, fontSize: CGFloat, height: CGFloat) -> NSAttributedString?
}

@objc public class LatexParser: NSObject, LatexParserProtocol {
